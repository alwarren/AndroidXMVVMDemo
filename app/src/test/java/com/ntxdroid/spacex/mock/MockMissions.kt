package com.ntxdroid.spacex.mock
    ...
    companion object {
        val list = listOf(
            ...
            Mission(
                ...
                "EE86F74",
                listOf("SpaceX"),
                listOf("Dragon Qualification Unit", "COTS Demo Flight 1", "COTS Demo Flight 2", "SpaceX CRS-1", "SpaceX CRS-2", "SpaceX CRS-3", "SpaceX CRS-4", "SpaceX CRS-5", "SpaceX CRS-6", "SpaceX CRS-7", "SpaceX CRS-8", "SpaceX CRS-9", "SpaceX CRS-10", "SpaceX CRS-11", "SpaceX CRS-12", "SpaceX CRS-13", "SpaceX CRS-14", "SpaceX CRS-15"),
            ...
            Mission(
                ...
                "F3364BF",
                listOf("Orbital ATK"),
                listOf("Iridium NEXT 1", "Iridium NEXT 2", "Iridium NEXT 3", "Iridium NEXT 4", "Iridium NEXT 5", "Iridium NEXT 6", "Iridium NEXT 7", "Iridium NEXT 8"),
